      ...
      <div className="contact-container">
        ...
        <div className="contact-content-simple">
          ...
          <div className="whatsapp-card">
            <h3>Escríbenos</h3>
            <p>¿Tienes alguna pregunta o quieres hacer una reserva?</p>
            <a 
              href="https://wa.me/573242090985?text=Hola! Me gustaría información sobre GreenBite Café" 
              target="_blank" 
